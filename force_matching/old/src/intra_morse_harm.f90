subroutine intra_morse_harm(r,dvdr,dvdr_stretch,dvdr_bend,na,v,vir)
  implicit none
  include 'globals.inc'
  ! ------------------------------------------------------------------
  ...
  real(8) alpb,f1,f2,deb,a1,a2,a3
  ...
  do j = 1,na,3
     ...
     !hacked in, contains some unnecessary repeated calculations
