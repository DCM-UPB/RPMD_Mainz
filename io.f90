...
subroutine print_dipole_int(dtfs,nt,irmtr,irmtv,iskip)
    implicit none
  include 'globals.inc'
    ! ------------------------------------------------------------------
    ...
    do it = 0,nt,iskip
        tps = it*dtps
        write (11,*)tps, irmtr(it,1,1)
        write (13,*)tps, irmtv(it,1,1)
    enddo
    close (unit=11)
    close (unit=13)
    ...
    do it = 0,nt,iskip
        tps = it*dtps
        write (11,*)tps, irmtr(it,2,1)
        write (13,*)tps, irmtv(it,2,1)
    enddo
    close (unit=11)
    close (unit=13)
    ...
    do it = 0,nt,iskip
        tps = it*dtps
        write (11,*)tps, irmtr(it,1,2)
        write (13,*)tps, irmtv(it,1,2)
    enddo
    close (unit=11)
    close (unit=13)
...
subroutine print_orientation(dtfs,nt,dmo1,iskip)
    implicit none
  include 'globals.inc'
    ! ------------------------------------------------------------------
